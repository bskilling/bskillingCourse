...
//             <div className="bg-white p-2 md:p-8 rounded-md max-w-md md:w-full md:max-w-xl flex flex-col md:flex-row relative z-10001">
//                 <span className="absolute top-[-7px] right-[-8px] text-gray-600 text-xl cursor-pointer transition-transform transform hover:scale-110" onClick={onClose}>
//                     <img src="/cross.png" alt="close" className="w-6 h-6" />
//                 </span>
//                 <div className="md:w-1/2 overflow-hidden">
//                     <img src="/popupImg.jpg" alt="Image" className="w-full h-full hidden md:inline-block" />
//                 </div>
//                 <div id='crmWebToEntityForm' className='md:w-1/2 md:ml-4'>
//                     <meta name='viewport' content='width=device-width, initial-scale=1.0' />
//                     {/* <META HTTP-EQUIV='content-type' CONTENT='text/html;charset=UTF-8' /> */}
//                     <form
//                         id='webform'
...
//                         method='POST'
//                         acceptCharset='UTF-8'
//                         onSubmit={handleSubmit} // Add the handleSubmit function to handle form submission
//                         target='_blank'
//                     >
//                         <input
//                             className='shadow-md w-full p-2 focus:ring focus:ring-blue-500 text-sm mb-2'
//                             type='text'
//                             id='First_Name'
//                             name='First Name'
...
//                             maxLength='40'
//                             required
//                             onFocus={toggleTooltip} // Show tooltip on focus
//                             onBlur={toggleTooltip} // Hide tooltip on blur
//                         />
//                         {showTooltip && (
//                             <div className='zcwf_col_help'>Your tooltip content here</div>
//                         )}
//                         <input
//                             className='shadow-md w-full p-2 focus:ring focus:ring-blue-500 text-sm mb-2'
//                             type='text'
...
//                                     type='submit'
//                                     id='formsubmit'
//                                     className='bg-blue-500 text-white text-sm px-4 py-2 rounded-md mr-2 hover:bg-blue-600 focus:outline-none focus:ring focus:border-blue-300'
//                                     title='Submit'
//                                 >
//                                     Submit
//                                 </button>
//                                 <button
//                                     type='reset'
//                                     className='bg-gray text-gray-700 px-4 py-2 text-sm rounded-md hover:bg-gray-400 focus:outline-none focus:ring focus:border-gray-300'
//                                     name='reset'
//                                     title='Reset'
//                                 >
//                                     Reset
