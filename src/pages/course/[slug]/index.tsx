...
// Extended interfaces to include metadata
interface IMetadata {
  _id?: string;
  courseId?: string;
  metaTitle?: string;
  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="canonical"
          href={`${process.env.NEXT_PUBLIC_WEBSITE_URL}/course/${courseData?.slug}`}
        />
        ...
        <meta
          property="og:url"
          content={`${process.env.NEXT_PUBLIC_WEBSITE_URL}/course/${courseData?.slug || courseData?._id}`}
        />
