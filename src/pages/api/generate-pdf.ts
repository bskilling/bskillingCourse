...
const generatePDF = async (req: NextApiRequest, res: NextApiResponse) => {
  ...
  doc.font('customFontBold').fontSize(18).fillColor('#135582').text(title, { align: 'center' });
  doc.moveDown(0.5);
  ...
  doc.moveDown(0.5);
  doc.fontSize(14).fillColor('#125582').text('').text('or write to us at', { align: 'center' });
  doc.moveDown(0.2);
  ...
  doc.moveDown(0.5);
  doc.fillColor('black').fontSize(13).font('semibold').text(`Price: ${price} (INR)`);
  doc.moveDown(0.5);
  ...
  doc.font('customFontBold').fontSize(15).fillColor('#135582').text('Overview', { align: 'left' }); //title overview
  doc.moveDown(0.5);
  ...
  doc.moveDown(0.9);
  doc.font('customFontBold').fontSize(15).fillColor('#135582').text('Audience', { align: 'left' }); //title objectives
  doc.moveDown(0.5);
  ...
  doc.moveDown(0.9);
  doc.font('customFontBold').fontSize(15).fillColor('#135582').text('Resources', { align: 'left' }); //title objectives
  doc.moveDown(0.5);
  ...
  doc.moveDown(0.9);
  doc.font('customFontBold').fontSize(15).fillColor('#135582').text('Benefits', { align: 'left' }); //title objectives
  doc.moveDown(0.5);
  ...
  doc.font('customFontBold').fontSize(15).fillColor('#135582').text(Curriculum, { align: 'left' });
  ...
  doc.moveDown(0.9);
  doc.font('customFontBold').fontSize(15).fillColor('#135582').text('Outcomes', { align: 'left' }); //title objectives
  doc.moveDown(0.5);
  ...
  doc.font('customFontBold').fontSize(15).fillColor('#135582').text('FAQs', { align: 'left' });
