      ...
      <div className="">
        ...
        <div className="md:w-[80vw] md:px-0 px-4 w-full m-auto">
          <h1 className="md:text-4xl text-xl font-bold md:font-medium text-center text-[#004aad] mt-10">
            Empowering India&#39;s Workforce: NSDC Skill Development Program for Career Success
          </h1>
          <p className="mt-5 pr-10 border-l-4 border-[#004aad] pl-3">
            ...
            invites you to join an exclusive government-backed initiative designed to shape the
            future workforce of India. With a strong focus on empowering individuals with
            cutting-edge skills, this program offers unparalleled opportunities to master Generative
            AI and Cloud Computing through flexible learning options, real-world experience, and
            career advancement support.
          </p>
          <div>
            <p className="text-2xl text-center mt-10 text-[#004aad]">
              Revolutionize Your Career with Generative AI and Cloud Computing Training
            </p>
            <div className="grid md:grid-cols-2 gap-10 my-10">
              <div className="relative group">
                <section className="absolute inset-0 bg-black bg-opacity-60 group-hover:cursor-pointer text-white opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex flex-col justify-center p-6 overflow-y-auto">
                  <h2 className="text-2xl font-bold mb-4">AI and Career Opportunities</h2>
                  <p className="mb-4">
                    AI is transforming industries and creating exciting career paths.
                  </p>

                  <h3 className="text-xl font-semibold mb-2">Why Choose AI?</h3>
                  <p className="mb-4">High demand, competitive salaries, and innovative work.</p>

                  <h3 className="text-xl font-semibold mb-2">Essential Skills</h3>
                  <p className="mb-4">Key skills: programming, mathematics, and problem-solving.</p>

                  <h3 className="text-xl font-semibold mb-2">Future Scope</h3>
                  <p>
                    AI will shape future technologies like smart cities and autonomous vehicles.
                  </p>
                </section>
              ...
              <div className="relative group">
                <section className="absolute inset-0 bg-black bg-opacity-60 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex flex-col justify-center p-6 overflow-y-auto">
                  ...
                  <p className="mb-4">
                    Cloud computing is revolutionizing how businesses operate, offering scalable and
                    efficient solutions.
                  </p>

                  <h3 className="text-xl font-semibold mb-2">Why Choose Cloud Computing?</h3>
                  <p className="mb-4">High demand, flexibility, and significant cost savings.</p>

                  <h3 className="text-xl font-semibold mb-2">Essential Skills</h3>
                  <p className="mb-4">Key skills: cloud platforms, networking, and security.</p>

                  <h3 className="text-xl font-semibold mb-2">Future Scope</h3>
                  <p>Cloud computing will drive innovations in big data, IoT, and AI.</p>
                </section>
          ...
          <div className="mt-10">
            <h2 className="text-3xl text-[#004aad] pl-3">Why Choose This Program?</h2>
            <p className="mt-5 pr-10 border-l-4 border-[#ffe5c7] pl-3 ">
              Government-Backed Credibility Supported by the Skill India Mission, this initiative
              ensures affordability, inclusivity, and access to globally recognized certifications.
            </p>
            <div>
          ...
          <div className="mt-10">
            <h2 className="text-3xl text-[#004aad] pl-3">Flexible Learning Options</h2>
            <div className="border-l-4 border-[#004aad] pl-7 relative mt-10 pb-10 pr-20 ">
              ...
              <p className="-mt-5">
                Generative AI Free Basics (15 Hours): Perfect for curious minds starting their
                journey into AI, covering essential concepts and foundational knowledge.
              </p>
            </div>
            <div className="border-l-4 border-[#004aad] pl-7 relative pb-10 pr-20 ">
              <FaCircle className="absolute -left-2.5 top-1 text-[#004aad]" />
              <p>
                Generative AI Advanced (45 Hours): A deep dive into advanced generative
                technologies, hands-on projects, and tools like ChatGPT and DALL-E to build
                expertise.
              </p>
            </div>
            <div className="border-l-4 border-[#004aad] pl-7 relative  pr-20">
              ...
              <p>
                Cloud Computing Advanced (40 Hours): Comprehensive training in cloud solutions,
                including deployment, architecture, and management, with a focus on platforms like
        ...
        <div className="md:w-[80vw] md:px-0 px-4 w-full m-auto mt-10">
          <h2 className="text-3xl text-[#004aad] text-center pl-3">Career-Oriented Approach</h2>
          <p className="mt-4">
            From foundational training to advanced specializations, our courses are tailored to meet
            the demands of top employers. With real-world projects, you’ll graduate job-ready, armed
        ...
        <div className="mt-20 md:w-[80vw] md:px-0 px-4 m-auto w-full">
          <h2 className="text-3xl text-[#004aad] text-center pl-3">Program Features</h2>
          ...
          <div className="w-[80vw] mt-10 grid grid-cols-1 md:grid-cols-1 gap-10 items-center">
            <div className="  grid grid-cols-2 gap-x-10 gap-y-10">
              <p>
                <span className="font-bold text-xl">Generative AI and Cloud Computing Mastery</span>
                <span>
                  ◦ Explore the transformative potential of AI and the limitless capabilities of
                  cloud technologies.
                </span>
                <span>◦ Practical applications that prepare you for real-world challenges.</span>
              </p>
              <p>
                <span className="font-bold text-xl"> Flexible Learning Paths</span> Free
                foundational courses and paid advanced programs to suit your career goals.
              </p>
              <p>
                <span className="font-bold text-xl">Government-Supported Affordability</span>{' '}
                Leverage government schemes and subsidies to make advanced training accessible.
              </p>
              <p>
                <span className="font-bold text-xl">Skill India Digital Hub (SIDH)</span> A trusted
                learning platform providing seamless access to courses, resources, and
                certifications.
              </p>
              <p>
                <span className="font-bold text-xl">Inclusion and Accessibility</span> Tailored for
                learners from Tier 2 and Tier 3 cities, with a focus on bridging the skill gap
                across communities.
              </p>
            </div>
          </div>
        ...
        <div className="bg-gray-100 md:p-10 py-5 mt-10">
          <p className="text-4xl text-[#004aad] text-center pl-3 ">Who Should Join ?</p>
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-10 mt-10">
            <Card>
              <CardHeader>
                <CardTitle className="text-[#004aad]">Students and Beginners</CardTitle>
                <CardDescription>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Upgrade your expertise with advanced AI and Cloud Computing training to stay ahead
        ...
        <div className="xl:w-[80vw] md:py-10 py-4  px-4 w-full m-auto md:mt-0 mt-0 ">
          <div>
            <h1 className="text-4xl text-[#004aad]  text-center mt-10">Why Choose bSkilling?</h1>
            <p className="mt-4">
          ...
          <div>
            ...
            <p className="mt-4">
              This program is more than a course—it’s a movement to build a Digitally Skilled India.
              Supported by NSDC and bSkilling, this initiative is designed to empower you with the
              tools, knowledge, and support needed to succeed in the fast-paced world of technology.
              Don’t miss this opportunity to transform your future. Enroll today for free Generative
              AI basics, or take the next step with advanced learning and hands-on experience in
          ...
          <div className="mt-10">
            <div className="mt-5 flex gap-x-3 items-center justify-center">
              ...
              Email:
              <a href="mailto:contact.nsdc@bskilling.com" className="text-primary ">
