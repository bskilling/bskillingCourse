      ...
      <div className="">
        ...
        <div className="md:w-[80vw] md:px-0 px-4 w-full m-auto">
          <h1 className="md:text-4xl text-xl font-bold md:font-medium text-center text-[#8f0808] mt-10">
            Empowering India&#39;s Digital Future: NASSCOM Skill Development for a Tech-Ready
            Workforce
          </h1>
          <p className="mt-5 pr-10 border-l-4 border-[#8f0808] pl-3">
            ...
            The National Association of Software and Service Companies (NASSCOM), in partnership
            with bSkilling, proudly presents a groundbreaking initiative designed to shape India’s
            digital future. By combining NASSCOM’s industry leadership and bSkilling’s innovative
            training expertise, this collaboration aims to empower individuals with future-ready
            skills, bridging the gap between aspirations and opportunities in technology and
            professional domains.
          </p>
          <div>
            <div className="">
              <p className="text-2xl  mt-10 text-[#8f0808]">Why Choose NASSCOM and bSkilling?</p>{' '}
              <div className="mt-5 pr-10 border-l-4 border-[#8f0808] pl-3">
                <p>
                  <span className="font-bold text-[#8f0808]">Unmatched Industry Expertise </span>
                  Led by global leaders in IT and professional development, NASSCOM and bSkilling
                  offer a unique blend of innovation, relevance, and excellence. Programs are
                  carefully designed to align with industry standards and emerging trends, ensuring
            ...
            <div className="">
              ...
              <p className="mt-5 pr-10 border-l-4 border-[#8f0808] pl-3">
                Our diverse range of courses caters to everyone—from students and fresh graduates to
                seasoned professionals looking to upgrade their skills:
              </p>
            </div>

            <div className="mt-10">
              <h3 className="text-2xl text-center mt-10 bg-[#8f0808] text-white p-2">Categories</h3>

              <div className="mt-5">
                <h3 className="bg-[#8f0808] text-white p-2 w-fit">Aligned Course</h3>
                <div className="grid md:grid-cols-3 grid-cols-1 gap-10">
                  <Card>
                    <CardHeader className="h-32">
                      <CardTitle>Artificial Intelligence and Machine Learning (50 Hours)</CardTitle>
                      <CardDescription>
                        Dive deep into the advanced concepts of AI and ML, focusing on cutting-edge
                        tools and applications.
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <img src="/new-image/ai.jpg" alt="" className="w-full h-80 object-cover" />
                    </CardContent>
                  </Card>
                  <Card>
                    <CardHeader>
                      <CardTitle>
                        Generative AI - Artificial Intelligence and Machine Learning (15 Hours):
                      </CardTitle>
                      <CardDescription>
                        Start your journey with foundational AI knowledge tailored for beginners.
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <img src="/new-image/aii.jpg" alt="" className="w-full h-80 object-cover" />
                    </CardContent>
                  </Card>
                  <Card>
                    <CardHeader>
                      <CardTitle>Introduction to Cloud Computing (12 Hours):</CardTitle>
                      <CardDescription>
                        Explore the essentials of cloud technologies, covering fundamental concepts,
              ...
              <div className="mt-10">
                <h3 className="bg-[#8f0808] text-white p-2 w-fit">Non-Aligned Course</h3>
                <div className="grid md:grid-cols-3 grid-cols-1 gap-10">
                  <Card>
                    <CardHeader className="h-32">
                      <CardTitle>PMI - Project Management Professional (PMP) (35 Hours)</CardTitle>
                      <CardDescription>
                        Gain mastery in project management with globally recognized methodologies
                        and practices.
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <img src="/new-image/pm.jpg" alt="" className="w-full h-80 object-cover" />
                    </CardContent>
                  </Card>
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Understand IT service management frameworks to effectively align IT with
                        business goals.
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <img src="/new-image/it.jpg" alt="" className="w-full h-80 object-cover" />
                    </CardContent>
                  </Card>
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Acquire expertise in process-based project management techniques adaptable
                        to any industry.
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                      <img src="/new-image/prm.jpg" alt="" className="w-full h-80 object-cover" />
                    </CardContent>
                  </Card>
                </div>
              </div>
            ...
            <div className="flex flex-col space-y-5 border-l-4 pl-5 mt-20">
              <h2 className="text-3xl  text-[#8f0808]">Globally Recognized Certifications</h2>
              <p className="">
                From practical, hands-on projects to mentorship by industry experts, every aspect of
                our programs is designed to make you job-ready. Gain access to exclusive job portals
                and unlock opportunities with top employers.
              </p>
            </div>
          </div>
          <div className="flex flex-col space-y-5 border-l-4 pl-5 mt-20">
            ...
            <p>
              <span className="text-[#8f0808] font-bold">Real-World Applications</span>
            ...
            <p>
              ...
              The partnership between NASSCOM and bSkilling combines the strengths of two
              powerhouses: NASSCOM’s unparalleled industry insights and bSkilling’s innovative
              learning frameworks.
            </p>
            <p>
              <span className="text-[#8f0808] font-bold">Flexibility for Every Learner</span>
              Courses are tailored to meet the needs of diverse learners, whether you’re a student
              from a Tier 3 city or a professional balancing work and studies.
            </p>
            <p>
              <span className="text-[#8f0808] font-bold">
                Networking and Mentorship Opportunities
              </span>{' '}
              Gain access to a robust network of peers, mentors, and employers, creating pathways to
        ...
        <div className="bg-gray-100 md:p-10 py-5 mt-10">
          <p className="text-4xl text-[#8f0808] text-center pl-3 ">Who Should Join ?</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mt-10">
            <Card>
              <CardHeader>
                <CardTitle className="text-[#8f0808]">Students and Fresh Graduates</CardTitle>
                <CardDescription>
                  Build a strong foundation in technology and professional skills to launch your
                  career.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <img src="/new-image/students.jpg" alt="" className="w-full object-cover h-80" />
              </CardContent>
            </Card>
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Upgrade your skills in emerging technologies and professional domains to stay
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Turn your passion for AI, cloud computing, or project management into a thriving
                  career.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <img src="/new-image/tech.jpg" alt="" className="w-full object-cover h-80" />
              </CardContent>
            </Card>
          </div>
        </div>
        ...
        <div className="xl:w-[80vw] md:py-10 py-4  px-4 w-full m-auto md:mt-0 mt-0 ">
          <div>
            <h1 className="text-4xl text-[#8f0808]  text-center mt-10">Why Choose bSkilling?</h1>
            <p className="mt-4">
          ...
          <div>
            ...
            <p className="mt-4">
              ...
              transforming India into a global hub of innovation and technology. Together, NASSCOM
              and bSkilling are dedicated to empowering individuals, creating opportunities, and
              driving progress.
            </p>
            <div className="p-6 bg-gray-100 rounded-lg  mt-5">
              <h1 className="text-2xl font-bold text-gray-800">Your Digital Journey Starts Here</h1>
              ...
              <ul className="list-disc list-inside mt-2 text-gray-700">
                ...
                <li>
                  Advance your expertise with premium programs in Cloud Computing, Professional
                  Skills, and more.
                </li>
                <li>Join a community that’s shaping the future of technology and innovation.</li>
              </ul>
              <p className="mt-4 text-gray-700">
                Take charge of your career and become a part of India’s digital revolution. Let
                NASSCOM and bSkilling guide you on your path to success.
              </p>
            </div>
          </div>
          <div className="mt-10">
