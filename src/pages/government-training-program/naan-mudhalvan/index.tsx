  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:title"
          content="Naan Mudhalvan - Empowering Leaders"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://yourwebsite.com/naan-mudhalvan"
        />
      ...
      <div className="">
        ...
        <div className="md:w-[80vw] md:px-0 px-4 w-full m-auto">
          <h1 className="md:text-4xl text-xl font-bold md:font-medium text-center mt-10">
            Empowering Tamil Nadu’s Youth: Naan Mudhalvan Skill Development
            Program for Career Success
          </h1>
          <p className="mt-5 pr-10 border-l-4 border-[#304443] pl-3">
            In a rapidly evolving job market, the right skills and opportunities
            can transform careers and drive economic growth. The “Naan Mudhalvan
            Skill Development Program” initiated by the Government of Tamil
            Nadu, is a groundbreaking initiative aimed at empowering the state’s
            youth by bridging the gap between education and employment, this
            program ensures participants are industry-ready, fostering inclusive
            growth and sustainable development. In collaboration with bSkilling,
            a leading training institute, the program delivers cutting-edge,
            industry-aligned training to build a future-ready workforce for
            students.
          </p>
          <div className="mt-10">
            ...
            <p className="mt-5 pr-10 border-l-4 border-[#ffe5c7] pl-3 ">
              Since its launch, the Naan Mudhalvan program has been dedicated to
              equipping Tamil Nadu students with the skills needed to excel in
              the global job market with a focus on inclusivity and innovation.
            </p>
            <div>
          ...
          <div className="mt-10">
            ...
            <div className="border-l-4 border-[#304443] pl-7 relative mt-10 pb-10 pr-20 ">
              ...
              <p className="-mt-5">
                Empowering thousands of students: through specialized skill
            ...
            <div className="border-l-4 border-[#304443] pl-7 relative pb-10 pr-20 ">
              ...
              <p>
                Enabling diverse job placements: with a robust network of
                industry connections, bSkilling ensures participants access
                meaningful employment opportunities, including partnerships with
                500+ Fortune companies and collaborations with 850 job
                consultancy firms.
              </p>
            </div>
            <div className="border-l-4 border-[#304443] pl-7 relative  pr-20">
              ...
              <p>
                Focusing on underserved regions: ensuring rural youth gain
          ...
          <div className="w-[80vw] mt-10 grid grid-cols-1 md:grid-cols-2 gap-10 items-center m-auto">
            <div className="  flex flex-col gap-y-10">
              <p>
                ...
                Courses are designed to meet the needs of industries like IT,
                IoT, Industry 4.0, Fintech, and Graphic Design, equipping
                participants with in-demand skills for technology,
                manufacturing, finance, and design sectors.
              </p>
              <p>
                <span className="font-bold text-xl">
                  {' '}
                ...
                Hands-on training with industry-standard tools prepares
                participants to excel in the workplace.
              </p>
              <p>
                <span className="font-bold text-xl">
                  Inclusion-Focused Initiatives:
                </span>{' '}
                Special emphasis on reaching under-privileged students, ensuring
              ...
              <p>
                ...
                Training that equips Tamil Nadu’s youth to compete on a global
                scale.
              </p>
            </div>
              ...
              <CardContent>
                <div>
                  ...
                  <div className="space-y-6 mt-2">
                    ...
                    <li>
                      Focus on emerging technologies and essential skills.
                    </li>
                    <li>
                      Practical, hands-on learning to apply knowledge in
              ...
              <CardContent>
                <div className="space-y-5">
                  <div className="space-y-5">
                    ...
                    <li>
                      Support in exploring career options and setting achievable
                      goals.
                    </li>
                    <li>
                      Assistance with resume building, interview preparation,
                      and career planning.
                    </li>
                  </div>
                </div>
            ...
            <Card className="bg-gradient-to-t from-[#3459ff] to-[#53a1c5] p-8 text-white  rounded-none shadow-2xl">
              ...
              <CardContent>
                <div className="space-y-5">
                  <div className="space-y-5">
                    <li>
                      Strong network of industry partners for job placement.
                    </li>
                    <li>
                      Access to job fairs and exclusive recruitment drives.
                    </li>
                      ...
                      <CardContent className=" justify-center px-0">
                        <div className=" justify-center">
                          ...
                          <div className="px-5">
                            ...
                            <p className="mt-3">
                              Each course includes 45 hours of intensive,
                      ...
                      <CardContent className="px-0">
                        ...
                        <div className="p-5">
                          ...
                          <p className=" font-semibold mt-5">
                            Engaging in-person sessions conducted at respective
                            institutions, led by experienced industry
                            professionals with proven expertise in their fields.
                          </p>
                        </div>
                      </CardContent>
                    </Card>
        ...
        <div className="md:w-[80vw] w-full m-auto mt-20">
          ...
          <div className="grid md:grid-cols-2  gap-10 mt-10">
            <div className="p-10 bg-[#304443] text-white text-sm">
              <p className="text-[#ffe5c7] font-bold text-lg">
                Engineering Students in Third-year / fifth-semester students
                from Anna University-affiliated colleges.
              </p>
              <div className="space-y-5">
                ...
                <p>
                  • Core concepts of IoT, including sensor integration, data
                  communication, cloud connectivity, and industrial use cases.
                </p>
                <p>
                  • Advanced topics such as smart manufacturing, automation,
                  digital transformation, and real-time data analytics for
            ...
            <div className="p-10 bg-[#ffe5c7]">
              <p className="text-[#304443] font-bold">
                Arts and Science Students: Undergraduate students from colleges
                affiliated with Bharathiar University and Periyar University.
              </p>
              <div className="text-sm space-y-5 mt-5">
                <h2 className="font-bold">Fintech:</h2>
                <div className=" space-y-5">
                  <p>
                    • Financial Modeling and Valuation: Analysis of financial
                    statements, creation of projection models, valuation
                    methods, and strategies for investment decisions.
                  </p>
                  <p>
                    • GST Compliance and Auditing: In-depth understanding of
                    Goods and Services Tax, tax filing processes, auditing
                    practices, and adherence to Indian regulatory standards.
                  </p>
                </div>

                <h2 className="font-bold">Graphic Design:</h2>
                <p className="">
                  • Fundamentals of design principles, mastery of tools like
                  Adobe Photoshop, Illustrator, and Canva, and building a
                  professional portfolio through industry-oriented projects.
                </p>
              </div>
            </div>
          </div>
          <div className="px-5 md:px-0">
            ...
            <div className="space-y-5 mt-5">
              <p>
                <span className="text-xl font-bold space-x-4">
                  Industry Expertise:
                </span>{' '}
                Trainers with practical, real-world experience in relevant
                domains provide insights into current industry trends, tools,
                and technologies.
              </p>
              <p>
                <span className="text-xl font-bold space-x-4">
                ...
                Emphasis on practical sessions, case studies, and project-based
                learning to ensure students gain actionable skills.
              </p>
              <p>
                <span className="text-xl font-bold space-x-4">
                  Customized Curriculum:{' '}
                </span>{' '}
                Designed in collaboration with industry experts to align with
              ...
              <p>
                ...
                Students receive certificates upon successful completion,
                enhancing their profiles for job placements and internships.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="md:w-[80vw] px-4 md:px-0 m-auto">
            ...
            <div className="mb-8">
              ...
              <ul className="list-disc list-inside text-gray-600 space-y-2">
                <li>
                  So far, 2,000 students have been successfully trained in
                  Industrial IoT and Industry 4.0, equipping them with
                  cutting-edge knowledge and practical skills.
                </li>
                <li>
                  Gain hands-on knowledge of Industrial IoT and Industry 4.0
                  concepts.
                </li>
                <li>
                  Understand the role of automation, smart devices, and data in
                  transforming manufacturing and industrial operations.
                </li>
                <li>
                  Be prepared for roles in industries focusing on digital
                  transformation, industrial automation, and IoT implementation.
                </li>
              </ul>
            </div>
            ...
            <div className="">
              ...
              <ul className="list-disc list-inside text-gray-600 space-y-2">
                <li>
                  Currently, 21,000 students are undergoing training in Fintech
                  courses, including Financial Modelling and Valuation, GST
                  Compliance and Auditing, and Graphic Design, ensuring they are
                  industry-ready for careers in finance, accounting, and
                  creative industries.
                </li>
                <li>
                  Acquire in-depth knowledge of Fintech tools like financial
                  modeling, valuation techniques, and GST compliance for career
                  opportunities in finance and accounting.
                </li>
                <li>
                  Develop proficiency in graphic design tools, enabling creative
                  roles in advertising, digital marketing, and multimedia
                  design.
                </li>
                <li>
                  Gain an edge in the job market by developing a portfolio of
                  projects showcasing their skills.
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="xl:w-[80vw] md:py-10 py-4  px-4 w-full m-auto md:mt-0 mt-0 ">
          <div>
            <h1 className="text-4xl text-[#304443]  text-center mt-10">
          ...
          <div>
            ...
            <p className="mt-4">
              The Naan Mudhalvan Skill Development Program, in collaboration
              with bSkilling, is more than a training initiative—it’s a gateway
              to a brighter future. Whether you’re a student, job seeker, or
              professional looking to enhance your skills, this program is
          ...
          <div className="mt-10">
            <div className="mt-5 flex gap-x-3 items-center justify-center">
              ...
              Email:
              <a
                href="mailto:contact.naanmudhalvan@bskilling.com"
