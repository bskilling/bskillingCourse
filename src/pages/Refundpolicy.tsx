        ...
        <div className="mb-5 md:p-0 p-8 mt-8">
          ...
          <div className="mt-4">
            ...
            <p className="mt-1  md:ml-6">
              ...
              for more than 1 day, or downloaded the e-book, you will not be
              eligible for a refund. Refund requests received after 7 days will
              not be processed.
            </p>
          </div>
          ...
          <div className="mt-4">
            ...
            <p className="mt-2 md:ml-6">
              ...
              the order has more than one item, please contact the support team
              through the &quot;Help &amp; Support&quot; section of the website.
            </p>
          </div>
