                  ...
                  <div>
                    ...
                    <div className=" flex md:flex-row flex-col">
                      ...
                      <div className="md:w-[500px] justify-end  mr-2 _pt-8 items-end  flex flex-row gap-3">
                        ...
                        <div className="md:w-fit flex-3 w-full  h-[300px]  md:h-fit flex justify-center">
                          <iframe
                    ...
                    <div className="flex w-full md:flex-row gap-20 flex-col  justify-center">
                      ...
                      <div className="flex flex-col md:w-[50%]">
                        <div className=" rounded-md px-4 pb-4 ">
                          <p className="_pt-8 pb-4 text-xl text-right font-semibold">
                            Skills Covered
                          </p>
                          <div className="flex md:flex flex-wrap  justify-end items-end   flex-col gap-5">
