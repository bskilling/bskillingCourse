...
const LearningForm: React.FC<learningFormProps> = ({ onClose }) => {
  ...
  const sendToZohoCRM = (data: any) => {
    ...
    myHeaders.append(
      'Authorization',
      'Zoho-oauthtoken 1000.166e67392c11e6e21c370b528b8faca8.72a957677f7fb4ed6ddd617be0141377'
    );
    myHeaders.append('Content-Type', 'application/json');
    myHeaders.append(
      'Cookie',
      '1a99390653=5e5fe628d7b2d0b8b6ba5ce4ffecdb6a; JSESSIONID=86F3D23F65F2B7AA1C34DB8352606C0D; _zcsr_tmp=f1789312-d34a-467f-91bf-f7513ae16a76; crmcsr=f1789312-d34a-467f-91bf-f7513ae16a76; group_name=usergroup1'
    );
