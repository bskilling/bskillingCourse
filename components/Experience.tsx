...
const Experience = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center w-full px-4 mt-20 py-10 md:px-20 lg:px-30">
            <h1 className="text-3xl font-bold text-center mb-4 md:text-4xl">THE BSKILLING EXPERIENCE</h1>
            <p className="text-lg text-center mb-8 md:text-xl">Transforming Careers Through Innovative Learning</p>
            ...
            <div className="flex flex-col w-full bg-white shadow-lg rounded-lg overflow-hidden relative mb-6 md:flex-row md:mb-20 md:py-14 py-4">
                ...
                <div className="flex flex-col items-center w-full p-4 text-center md:w-1/2">
                    <img src="/images/Personalised_learning.png" alt="Personalised Learning" className="w-10 h-10 mb-4 rounded-lg" />

                    <div className="ml-2">
                        <h2 className="text-xl font-bold mb-2 md:text-2xl">Personalised Learning</h2>
                ...
                {/* Right half */}
                <div className="flex flex-col items-center w-full p-4 text-center md:w-1/2">
                    <img src="/images/easy_course.png" alt="Easily Accessible Courses" className="w-10 h-10 mb-4 rounded-lg " />

                    {/* The dividing line, hidden on mobile */}
                    {/* <div className="absolute left-0 top-0 bottom-0 w-[1px] bg-textColor"></div> */}

                    <div className="ml-2">
                        <h2 className="text-xl font-bold mb-2 md:text-2xl">Easily Accessible Courses</h2>
                        <p className="text-base text-justify text-textColor md:text-sm">
            ...
            <div className="flex flex-col w-full bg-white shadow-lg rounded-lg overflow-hidden py-4 md:flex-row">
                {/* Left half */}
                <div className="flex flex-col items-center w-full p-4 text-center md:w-1/2">
                    <img src="/images/lms_access.png" alt="Convenient Learning with LMS Access" className="w-10 h-10 mb-4 rounded-lg" />

                    <div className="ml-2">
                        <h2 className="text-xl font-bold mb-2 md:text-2xl">Convenient Learning with LMS Access</h2>
                        <p className="text-base text-justify text-textColor md:text-sm">
                ...
                {/* Right half */}
                <div className="flex flex-col items-center w-full p-4 text-center md:w-1/2">
                    <img src="/images/support.png" alt="Projects and Mentor Support" className="w-10 h-10 mb-4 rounded-lg" />

                    {/* The dividing line, hidden on mobile */}
                    {/* <div className="hidden md:block relative left-20 top-0 bottom-0 w-[1px] bg-textColor"></div> */}

                    <div className="ml-2">
                        <h2 className="text-xl font-bold mb-2 md:text-2xl">Projects and Mentor Support</h2>
                        <p className="text-base text-justify text-textColor md:text-sm">
