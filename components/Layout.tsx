      ...
      <>
        ...
        {navHide && isVisible && (
          <div className="bg-card shadow-lg sticky top-0 z-50">
            <nav className="py-2 h-[70px] 2xl:w-[85vw] w-full m-auto  px-5  font-SourceSans p-0  flex flex-row items-center justify-between gap-x-5  text-foreground  ">
              <div className="flex gap-x-4 items-center">
                ...
                <Courses />
                <div className="relative hidden md:flex border border-blue-400  font-SourceSans w-[400px]  md:w-[360px] ">
                  <input
                    type="text"
                    className="w-full h-[40px] text-[14px]   bg-gray px-5 outline-none focus:outline-none"
                    placeholder="Search for the course or skills"
                    required
                    value={inputValue}
                    onChange={handleSearch}
                  />
                  <div className=" bg-primary  w-10 flex items-center justify-center">
              ...
              {/* <div className="flex absolute left-[270px] gap-4 mt-1"></div> */}
