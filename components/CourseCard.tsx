        ...
        >
          ...
          <div className="flex flex-col px-4 mt-2">
            ...
            <div className="flex mt-5 py-2 justify-center gap-5">
              ...
              <div>
                <button className="px-2 py-2 text-white bg-buttonBlue rounded-lg bg-buttonBlue hover:bg-buttonBlue focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm  dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                  View Course
                </button>
              </div>
            </div>
